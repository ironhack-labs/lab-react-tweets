...
function App() {
  ...
  return (
    <div className="App">
      ...
      {/*<Tweet name={tweetsArray[0].user["name"]} image={tweetsArray[0].user["image"]} handle={tweetsArray[0].user["handle"]} timestamp={tweetsArray[0].timestamp} message={tweetsArray[0].message} />*/}
